...
function Events() {
    return (
            ...
            <div className="h-[200px] w-[100%] bg-[#2f4f4f] rounded-xl albumbg overflow-hidden relative flex justify-center items-center">
            ...
            <div className="h-[280px] w-[100%] bg-[#222225] rounded-xl mt-6 flex flex-col items-center justify-center">
                <BsFillCalendarEventFill className="text-[32px]" />
                <h1 className=" mt-4">No events found</h1>
            </div>
        </div>
    )
}
