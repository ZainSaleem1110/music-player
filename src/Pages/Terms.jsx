    ...
    return (
        <div className="text-[#d2d2d2]">
            <div className="text-[15px] flex justify-center items-center border-b-2 border-[#323232] pb-3 font-bold">
                ...
                <Link to='/terms' className="flex relative text-[#ef8f1d] justify-center items-center w-[115px]">
                    TERMS
                    <div className="absolute bottom-[-14px] left-0 h-[2px] w-[115px] bg-[#ef8f1d]"></div>
                </Link>
