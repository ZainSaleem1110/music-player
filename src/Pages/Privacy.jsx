    ...
    return (
        <div className="text-[#d2d2d2]">
            <div className="text-[15px] flex justify-center items-center border-b-2 border-[#323232] pb-3 font-bold">
                <Link to='/aboutus' className="flex justify-center items-center w-[140px]">
                    ABOUT US
                </Link>
                <Link to='/terms' className="flex justify-center items-center w-[115px]">
                    TERMS
                </Link>
                <Link to='/policy' className="flex relative text-[#ef8f1d] justify-center items-center w-[190px]">
                    PRIVACY POLICY
                    <div className="absolute bottom-[-14px] left-0 h-[2px] w-[190px] bg-[#ef8f1d]"></div>
                </Link>
            ...
            <div className="bg-[#222225] rounded-lg p-3 mt-7">
                <h1 className="text-[24px] font-bold">1- Write your Privacy Policy here.</h1>
