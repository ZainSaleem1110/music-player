    ...
    return (
        <div className="text-[#d2d2d2]">
            <div className="text-[15px] flex justify-center items-center border-b-2 border-[#323232] pb-3 font-bold">
                ...
                <Link to='/policy' className="flex relative text-[#ef8f1d] justify-center items-center sm:w-[190px] w-[165px] text-[14px] ">
                    <div className="absolute bottom-[-14px] left-0 h-[2px] sm:w-[190px] w-[165px] bg-[#ef8f1d]"></div>
                    PRIVACY POLICY
                </Link>
