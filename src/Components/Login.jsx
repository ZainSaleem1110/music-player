...
function Login() {
    return (
        <div className="w-[55%] h-[520px] rounded-lg flex">
            <div className="w-[35%] h-[100%] bg-[#f98f1d] rounded-l-lg flex flex-col justify-between py-10 pl-7">
                <div>
                    <h1 className="text-[32px] font-bold">Login</h1>
                    <p className="mt-2">Get access to your music, playlists and account</p>
                </div>
                <img src={LoginImg} className="w-[100%]" alt="" />
            </div>
            <div className="w-[65%] h-[100%] bg-white rounded-r-lg px-8 py-10">
