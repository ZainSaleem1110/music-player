    ...
    return (
        <>
            <div className="flex justify-center items-center h-[108px] w-[100%] gap-5 border-b-2 border-[#444444] pb-7">
                <button className="bg-[#272729] border border-[#444444] flex flex-col items-center justify-center rounded-lg py-3 px-6" onClick={handleTabOne}>
                ...
                <button className="border border-[#444444] text-[#afafaf] flex flex-col items-center justify-center rounded-lg py-3 px-6" onClick={handleTabTwo}>
                    <div className="w-[33px] h-[33px] rounded-full flex justify-center items-center text-[20px]"><MdLibraryMusic /></div>
                    <p>Albums</p>
                </button>
                <button className="border border-[#444444] text-[#afafaf] flex flex-col items-center justify-center rounded-lg py-3 px-6" onClick={handleTabThree}>
                    <div className="w-[33px] h-[33px] rounded-full flex justify-center items-center text-[20px]"><BsGraphUp /></div>
                    <p>Top Seller</p>
                </button>
                <button className="border border-[#444444] text-[#afafaf] flex flex-col items-center justify-center rounded-lg py-3 px-6" onClick={handleTabFour}>
